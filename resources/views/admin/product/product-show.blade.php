...
<section class="content">
	...
	<table align="center" border="2" width="100%" class="table table-borderd table-condensed table-hover">
		...
		<tr align="center">
			...
			<td><img src="{{ asset($c->productPic) }}" class="img-responsive img-thumbnail" width="50px" height="40px"> </td>
			<!-- <td><img src="{{ asset('admin/productUploadPic/01.jpg') }}" width="50px"> </td> -->
			<td>{{ $c->cat_id }}</td>
			<td>{{ ($c->productStatus == 1)? 'Published' : 'Unpublished' }}</td>
			<td><a style="color: black;" href="{{ url('/product/edit/'.$c->id) }}" class="btn btn-primary"> Edit </a> |
