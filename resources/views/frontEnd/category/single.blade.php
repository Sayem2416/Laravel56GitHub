		...
		<div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<!-- //FlexSlider-->
					<ul class="slides">
						<li data-thumb="{{ asset('frontEnd/images') }}/a1.jpg">
							<div class="thumb-image"> <img src="{{ asset('frontEnd/images') }}/a1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="{{ asset('frontEnd/images') }}/a3.jpg">
							<div class="thumb-image"> <img src="{{ asset('frontEnd/images') }}/a3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="{{ asset('frontEnd/images') }}/a1.jpg">
							<div class="thumb-image"> <img src="{{ asset('frontEnd/images') }}/a1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
